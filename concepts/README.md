...
Track your overall concepts: **24 / 47 completed (51%)** *(read + revised)*

- **Written:** 37 / 47 — **79%** *(10 in backlog — the `*(todo)*` rows)*
- **Read:** 24 / 47 — **51%**
- **Revised:** 0 / 47 — **0%**
...
| | [Observability — logs, metrics, tracing, SLO](./09-reliability-and-operations/observability.md) | ☐ | ☐ | —             |
